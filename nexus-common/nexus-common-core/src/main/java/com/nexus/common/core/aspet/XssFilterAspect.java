package com.nexus.common.core.aspet;

import com.nexus.common.core.annotation.XssFilter;
import com.nexus.common.core.utils.StringEscapeUtils;
...
public class XssFilterAspect {
    ...
    @Pointcut("@annotation(com.nexus.common.core.annotation.XssFilter)")
