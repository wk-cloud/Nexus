...
import com.nexus.common.core.utils.IpUtils;
...
public class OperationLogAspect {
    ...
    public Object operationLog(ProceedingJoinPoint proceedingJoinPoint, OperationLog operationLog) throws Throwable {
        ...
        String username = TokenUtils.getValueFromToken(token, "userName");
        if (StringUtils.isBlank(username)) {
            username = userService.getUserNickName(userId);
        }
        ...
        operationLogEvent.setUserId(userId);
        operationLogEvent.setUsername(username);
        operationLogEvent.setIp(ipAddress);
        operationLogEvent.setModule(module);
        operationLogEvent.setOperationType(operationLog.operationType().name());
        operationLogEvent.setOperationDesc(operationLog.operationDesc());
        operationLogEvent.setRequestType(requestType);
