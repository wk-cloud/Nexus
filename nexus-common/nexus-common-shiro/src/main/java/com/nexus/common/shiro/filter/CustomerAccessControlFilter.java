package com.nexus.common.shiro.filter;
...
import com.nexus.common.shiro.CustomerAuthenticationToken;
import com.nexus.common.shiro.config.ShiroConfig;
...
public class CustomerAccessControlFilter extends BasicHttpAuthenticationFilter {
    ...
    private boolean isPass(ServletRequest request){
        ...
        if(ObjectUtils.isNull(webApplicationContext)) {
            return false;
        }
